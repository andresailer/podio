...
function(PODIO_GENERATE_DATAMODEL datamodel YAML_FILE RETURN_HEADERS RETURN_SOURCES)
  ...
  set_property(
    ...
    ${podio_PYTHON_DIR}/gen/generator_utils.py
    ${podio_PYTHON_DIR}/gen/podio_config_reader.py
    ${podio_PYTHON_DIR}/gen/generator_base.py
    ${podio_PYTHON_DIR}/gen/cpp_generator.py
    ${podio_PYTHON_DIR}/gen/julia_generator.py
  )
